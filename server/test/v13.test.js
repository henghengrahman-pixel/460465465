...
test('v1.3 boot worker exists',()=>{const s=fs.readFileSync('installer-bootstrap/main.go','utf8');assert.match(s,/StaffMonitorSystem/);assert.match(s,/ONSTART/);assert.match(s,/SYSTEM/)});
