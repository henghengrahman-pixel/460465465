...
test('v1.3 boot worker exists',()=>{const s=fs.readFileSync('install/StaffMonitorSetup-v1.4.cmd','utf8');assert.match(s,/StaffMonitorSystem/);assert.match(s,/ONSTART/);assert.match(s,/SYSTEM/)});
