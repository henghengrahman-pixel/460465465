...
try {
  ...
  await pool.query(`INSERT INTO users(id,login_id,password_hash,display_name,role)
    VALUES(gen_random_uuid(),$1,$2,'Super Admin','SUPER_ADMIN') ON CONFLICT(login_id) DO NOTHING`,[loginId,hash]);
